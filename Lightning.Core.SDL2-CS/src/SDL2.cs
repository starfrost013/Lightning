...
namespace NuRender.SDL2
{
    public static class SDL
    {
        ...
        /// </summary>
        private static string SDL2CS_VERSION = $"SDL.NET version {SDL2CS_VERSION_MAJOR}.{SDL2CS_VERSION_MINOR}.{SDL2CS_VERSION_REVISION} for Lightning & NuRender\n©2021-2022 starfrost ©2013-2021 Ethan Lee"; // cannot be const

        private const int SDL2CS_VERSION_MAJOR = 3;
        private const int SDL2CS_VERSION_MINOR = 0;
        private const int SDL2CS_VERSION_REVISION = 1;
        #endregion
