...
namespace NuCore.Utilities
{
 ...
 public static class ErrorRegistration
 {
     public static void RegisterErrors()
     {
         ...
         ErrorManager.RegisterError( new Error { Name = "MustDefineFontForGuiElementException", Description = "!!this should be overridden in code!!", Severity = MessageSeverity.Error, Id = 74 });
...
#region NuRender Errors
         ...
         ErrorManager.RegisterError(new Error { Name = "LWPakInvalidCatalogException", Description = "!!this should be overridden in code!!", Severity = MessageSeverity.Error, Id = 206 });
