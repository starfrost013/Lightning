...
/// </summary>
 public static class ErrorRegistration
 {
     public static void RegisterErrors()
     {
         ...
         ErrorManager.RegisterError( new Error { Name = "DummyError1Exception", Description = "this is a dummy error because i am retarded and Errors.xml will be killed soon", Severity = MessageSeverity.Message, Id = 74 } );
         ...
         ErrorManager.RegisterError( new Error { Name = "SkyObjectMustHaveTextureException", Description = "A Sky object must have a Texture!", Severity = MessageSeverity.FatalError, Id = 77 } );
